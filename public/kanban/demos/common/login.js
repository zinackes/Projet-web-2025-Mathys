...
function _initAuthContainer(containerId, users, onAuth) {
	...
	container.innerHTML = `
		<div class="auth-select-wrap" style="display: flex; flex-direction: column;"><label for="users">Choose user:</label>
		<select name="users" id="users-select" style="padding: 4px; border: 1px solid #d2cfcf; font-size:14px; height: 32px; width: 200px; margin: 5px 0 10px;"></select></div>
